...
def encryption(text, alphabet):
    ...
    result = ''
    for i in text:
        result += alphabet[length - alphabet.index(i) - 1]
    return result
...
def main():
    ...
    result_test = 'тъюсцоаосюяхчюпъкфчэсцшрняюсцоаусфияфчэсцних'  # ожидаемый результат шифрования
    ...
    if ch == 1:
        ...
        result_decryption = encryption(result_encryption, alphabet_test)
        ...
        # Процесс расшифрования и вывод результата
        result_decryption = encryption(result_encryption, alphabet_text)
